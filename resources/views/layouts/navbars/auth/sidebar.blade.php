<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            <img src="../assets/img/logoParaxute.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-1 font-weight-bold">PARAXUTE MUSIC</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'user-management' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Registro de Perfiles</span>
                </a>
            </li>

            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Control Escolar</h6>
            </li>
            <li class="nav-item">
